...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addEventListener("load", function () {
    if (document.body.classList.contains("page-template-page-gut-zu-wissen")) {
      ...
      faqQuestions.forEach(function (question) {
        question.addEventListener('click', function () {
          ...
          document.querySelectorAll('.icon-plus').forEach(function (icon) {
    ...
    if (document.body.classList.contains("unser-highlight-template-default")) {
      var _faqQuestions = document.querySelectorAll('.specs-title');
      _faqQuestions.forEach(function (question) {
        var answer = question.nextElementSibling;
        var icon = question.querySelector('.icon-plus img'); // Select the <img> inside .icon-plus
        ...
        question.addEventListener('click', function () {
          ...
          // Close all other answers
          document.querySelectorAll('.specs-text').forEach(function (el) {
            if (el !== answer) {
              el.style.maxHeight = el.scrollHeight + 'px'; // Set current height for smooth transition
              setTimeout(function () {
                return el.style.maxHeight = '0px';
              }, 10); // Trigger transition to 0
              el.classList.remove('open');
              el.previousElementSibling.classList.add('q-closed');
            }
          });
          document.querySelectorAll('.icon-plus img').forEach(function (img) {
            if (img !== icon) {
          ...
          if (!isOpen) {
            ...
            answer.style.maxHeight = answer.scrollHeight + 'px';
            setTimeout(function () {
              return answer.style.maxHeight = '0px';
            }, 10); // Smoothly transition to 0
          }
        });
      });
    }
...
if (thumbnailsContainer) {
  ...
  thumbnailsContainer.addEventListener('touchstart', function () {
    lenis.stop();
...
var threshold = 0;
var showScrollToTopThreshold = 400;

// Initial styles for scroll-to-top button
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(scrollToTopBtn, {
  autoAlpha: 0,
  y: 64
});
...
lenis.on('scroll', function (_ref) {
  ...
  var showScrollButton = scroll > showScrollToTopThreshold;
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(scrollToTopBtn, {
...
if (document.body.classList.contains("unser-highlight-template-default")) {
  ...
  var context = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.context(function () {
    if (window.matchMedia("(min-width: 1280px)").matches) {
      var sidebar = document.querySelector('#sticky-sidebar');
      var sidebarContainer = sidebar === null || sidebar === void 0 ? void 0 : sidebar.parentElement; // Parent container of the sidebar

      if (sidebar && sidebarContainer) {
        gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(sidebar, {
          scrollTrigger: {
            trigger: sidebar,
            start: 'top top+=100',
            // 100px gap from the top
            end: function end() {
              // Dynamically calculate the end with a 320px offset
              var containerBottom = sidebarContainer.getBoundingClientRect().bottom + window.scrollY;
              return "".concat(containerBottom - window.innerHeight - 660, "px top");
            },
            scrub: true,
        ...
        var accordionItems = document.querySelectorAll('.specs-item');
        accordionItems.forEach(function (item) {
          var toggleButton = item.querySelector('.specs-title');
  ...
  window.addEventListener('resize', function () {
    ...
    context = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.context(function () {
      if (window.matchMedia("(min-width: 1280px)").matches) {
        var sidebar = document.querySelector('#sticky-sidebar');
        if (sidebar) {
          gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(sidebar, {
            scrollTrigger: {
              trigger: sidebar,
              start: 'top top+=100',
              // Adds 100px gap from the top
              end: 'bottom+=500 top',
              // Sticky ends after 500px scroll or as needed
              scrub: true,
              // Smooth sticky behavior
              pin: true,
              // Makes the sidebar sticky
...
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swiper */ "./assets/js/swiper.js");
/* harmony import */ var _navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./navigation */ "./assets/js/navigation.js");
...
/* harmony import */ var _fancybox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fancybox */ "./assets/js/fancybox.js");
/* harmony import */ var _fancybox__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_fancybox__WEBPACK_IMPORTED_MODULE_4__);
...
window.addEventListener("load", function () {
  if (document.body.classList.contains("page-template-page-home")) {
    var heroSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".team-swiper", {
      lazy: {
      ...
      breakpoints: {
        768: {
          slidesPerView: 3,
          // Show all slides in 3 columns when viewport is less than 1024px
          grid: {
            rows: 2 // 2 rows for a grid layout
          },
          loop: false,
          // Disable looping for this layout
          spaceBetween: 16 // Adjust space between slides if needed
        },
        1024: {
          slidesPerView: 4,
          // Switch back to regular layout with 4 slides in view
          grid: {
            rows: 1
          },
          spaceBetween: 24
    ...
    var highlightsSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".highlights-swiper", {
      slidesPerView: 1,
      spaceBetween: 10,
      loop: true,
      navigation: {
  ...
  if (document.body.classList.contains("page-template-page-home") || document.body.classList.contains("page-template-page-uber-uns")) {
    var reviewSwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".reviews-swiper", {
      lazy: {
        loadOnTransitionStart: true
      },
      breakpoints: {
      ...
      pagination: {
        ...
        renderCustom: function renderCustom(swiper, current, total) {
          return "".concat(current, " von ").concat(total);
        }
      },
      navigation: {
        nextEl: ".arrow-right",
  ...
  if (document.body.classList.contains("page-template-page-uber-uns")) {
    var gallerySwiper = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".gallerySwiper", {
      slidesPerView: 1,
      spaceBetween: 24,
      loop: true,
      centeredSlides: true,
  ...
  if (document.body.classList.contains("unser-highlight-template-default-alternative")) {
    // Thumbnail slider
    var thumbnailSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.thumbnail-slider', {
      slidesPerView: 2,
      slidesPerGroup: 6,
      grid: {
        rows: 3,
    ...
    // Main slider
    var mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.highlights-slider', {
      slidesPerView: 1,
      spaceBetween: 10,
      effect: 'fade',
      navigation: {
  ...
  if (document.body.classList.contains("unser-highlight-template-default")) {
    var _mainSlider = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"]('.highlights-slider', {
      slidesPerView: 1,
      spaceBetween: 10,
      navigation: {
        nextEl: '.swiper-button-next',
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkauto_fischer"] = self["webpackChunkauto_fischer"] || [];
