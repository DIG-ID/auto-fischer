<div class="lg:flex lg:flex-col lg:justify-between lg:h-full pt-0 lg:pt-0 pb-10 lg:pb-0">
	<div class="grid grid-cols-2 md:grid-cols-6 xl:grid-cols-4 gap-x-6">
		...
		<div class="col-span-2 md:col-span-6 xl:col-span-3 border-y border-[#E1E1E1] pt-6 pb-4">
			...
			<p class="text-body mt-3"><?php esc_html_e( 'Verkauf / Eintausch / Ankauf / Leasing', 'fischer' ); ?></p>
		</div>
		<div class="col-span-2 md:col-span-6 xl:col-span-3 border-b border-[#E1E1E1] py-6">
			<p class="text-body !font-bold mb-0"><?php esc_html_e( 'Auto Fischer Ettingen GmbH', 'fischer' ); ?></p>
			<p class="text-body xl:pl-6 2xl:pl-12"><?php esc_html_e( 'Brühlstrasse 1, 4107 Ettingen', 'fischer' ); ?></p>
			<p class="text-body xl:pl-6 2xl:pl-12"><span class="font-medium"><?php esc_html_e( 'Tel: ', 'fischer' ); ?></span><a href="tel:<?php the_field( 'general_phone_number', 'option' ); ?>"><?php the_field( 'general_phone_number', 'option' ); ?></a></p>
			<p class="text-body mb-7 xl:pl-6 2xl:pl-12"><span class="font-medium"><?php esc_html_e( 'Mail: ', 'fischer' ); ?></span><a href="mailto:<?php the_field( 'general_email', 'option' ); ?>"><?php the_field( 'general_email', 'option' ); ?></a></p>
			<div class="schedule-sidebar">
				<p class="text-body !font-bold mb-0"><?php esc_html_e( 'Öffnungszeiten', 'fischer' ); ?></p>
				<?php
