<section class="section-form bg-transparent pb-24">
		...
		<div class="col-span-2 md:col-span-6 xl:col-span-5 xl:col-start-8 ">
			<div class="kontkact-box bg-white border border-[#E1E1E1] p-10 rounded-2xl">
					...
					if ( $contacts ) :
						...
						echo '<address class="contacts flex flex-col gap-y-8 justify-between text-body not-italic">';
						if ( $address ) :
							?>
							<div class="contacts-address flex gap-x-3">
								...
								<div class="contacts-address-content">
									<p><?php esc_html_e( 'Adresse', 'auto-fischer' ); ?></p>
						...
						if ( $email ) :
							...
							<div class="contacts-email flex gap-x-3">
								...
								<div class="contacts-email-content">
									<p><?php esc_html_e( 'Email', 'auto-fischer' ); ?></p>
						...
						if ( $phone ) :
							...
							<div class="contacts-phone flex gap-x-3">
								...
								<div class="contacts-phone-content">
									<p><?php esc_html_e( 'Telefon', 'auto-fischer' ); ?></p>
